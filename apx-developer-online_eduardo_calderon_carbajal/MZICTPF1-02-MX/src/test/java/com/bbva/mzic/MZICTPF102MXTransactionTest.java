...
/**
 * Test for transaction MZICTPF102MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/MZICTPF102MXTest.xml" })
public class MZICTPF102MXTransactionTest {

	@Autowired
	private MZICTPF102MXTransaction transaction;
